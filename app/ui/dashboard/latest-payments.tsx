...

 {
  return (
    <div className="flex w-full flex-col md:col-span-4">
      ...
      <div className="flex grow flex-col justify-between rounded-xl bg-payne-50 p-4">
        ...
        <div className="flex items-center pb-2 pt-6">
          <ArrowPathIcon className="h-5 w-5 text-payne-500" />
          <h3 className="ml-2 text-sm text-payne-600 ">Updated just now</h3>
        </div>
      </div>
    </div>
  );
